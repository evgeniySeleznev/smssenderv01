...
//jitter — чтобы в разное время пытаться отправить не прошедшие смс в диапазоне
//от 1 минуты до 4 часов (5 раз за этот интервал с экспоненциальной задержкой +- 20%)
